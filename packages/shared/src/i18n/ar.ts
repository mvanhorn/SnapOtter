...
export const ar: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "مجموعة أدوات معالجة صور ذاتية الاستضافة تركز على الخصوصية مع 51 أداة. تغيير الحجم والضغط والتحويل والعلامات المائية وأتمتة سير عمل الصور دون إرسال البيانات إلى السحابة.",
