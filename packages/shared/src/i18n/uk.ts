...
export const uk: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Самостійно розміщуваний набір інструментів для обробки файлів з пріоритетом конфіденційності, 157 інструментів. Конвертація, стиснення, редагування, транскрипція, OCR та автоматизація робочих процесів із зображеннями, відео, аудіо, документами та даними без надсилання даних у хмару.",
      versionLabel: "Версія:",
