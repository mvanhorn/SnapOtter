...
export const hi: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "51 टूल्स के साथ गोपनीयता-पहले, सेल्फ-होस्टेड इमेज प्रोसेसिंग सूट। क्लाउड को डेटा भेजे बिना रीसाइज़, कंप्रेस, कन्वर्ट, वॉटरमार्क और अपने इमेज वर्कफ्लो ऑटोमेट करें।",
      versionLabel: "वर्शन:",
      linksHeading: "लिंक्स",
