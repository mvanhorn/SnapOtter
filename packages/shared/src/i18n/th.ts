...
export const th: TranslationKeys = {
  ...
  settings: {
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "ชุดเครื่องมือประมวลผลไฟล์แบบโฮสต์เองที่เน้นความเป็นส่วนตัวพร้อม 157 เครื่องมือ แปลง บีบอัด แก้ไข ถอดเสียง OCR และทำงานอัตโนมัติกับภาพ วิดีโอ เสียง เอกสาร และข้อมูลโดยไม่ต้องส่งข้อมูลไปคลาวด์",
