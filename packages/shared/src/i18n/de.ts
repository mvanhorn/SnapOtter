...
export const de: TranslationKeys = {
  ...
  settings: {
    ...
    aiFeatures: {
      title: "AI Features",
      description: "AI-Modellpakete fuer erweiterte Dateiverarbeitung verwalten.",
    ...
    about: {
      ...
      appName: "SnapOtter",
      appDescription:
        "Eine selbst gehostete, datenschutzorientierte Dateiverarbeitungssuite mit 157 Werkzeugen. Konvertieren, komprimieren, bearbeiten, transkribieren, OCR und Bild-, Video-, Audio-, Dokument- und Datenablaeufe automatisieren, ohne Daten in die Cloud zu senden.",
  ...
  features: {
    ...
    progressMessages: [
      ...
      "Ihre Dateien werden es Ihnen spaeter danken...",
      "Laden... aber mit Stil...",
  ...
  help: {
    ...
    gettingStarted: {
      ...
      description:
        "Waehlen Sie ein Werkzeug aus der Seitenleiste oder suchen Sie nach einem. Laden Sie eine Datei hoch, indem Sie sie auf die Seite ziehen oder den Upload-Bereich anklicken. Passen Sie die Einstellungen an und laden Sie Ihr Ergebnis herunter.",
    },
    keyboardShortcuts: {
