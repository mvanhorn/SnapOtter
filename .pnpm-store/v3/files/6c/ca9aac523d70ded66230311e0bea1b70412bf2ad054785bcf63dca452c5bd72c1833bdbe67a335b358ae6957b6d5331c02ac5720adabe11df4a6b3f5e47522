import { NATIVE_COMPONENT_NAME, NATIVE_ELEMENT_NAME, NATIVE_SOURCE_FILE_NAME, WEB_COMPONENT_NAME, WEB_ELEMENT_NAME, WEB_SOURCE_FILE_NAME, getComponentAnnotationAttributes } from './component-annotation.js';
import { KNOWN_INCOMPATIBLE_PLUGINS } from './constants.js';
export { experimentalComponentNameAnnotatePlugin } from './experimental.js';
