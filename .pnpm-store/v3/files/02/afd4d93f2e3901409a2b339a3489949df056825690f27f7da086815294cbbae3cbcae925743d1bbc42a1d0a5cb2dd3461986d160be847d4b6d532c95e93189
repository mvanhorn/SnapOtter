...
export { serializeInstrumentations, deserializeInstrumentations, type SerializedRegExp, type SerializableInstrumentationConfig, type AnyInstrumentationConfig, } from './instrumentation-serde';
