...
var LazyLoadedSessionRecording = /** @class */ (function () {
    function LazyLoadedSessionRecording(_instance) {
        ...
        this._onSessionIdCallback = function (sessionId, windowId, changeReason) {
            ...
            if (_this._isIdle === true || !_this.isStarted) {
    ...
    LazyLoadedSessionRecording.prototype._captureProcessedEvent = function (event, eventToSend, size, targetSessionId, targetWindowId) {
        ...
        if (event.type === rrweb_types_1.EventType.FullSnapshot && ((_b = (_a = getRRWeb()) === null || _a === void 0 ? void 0 : _a.wasMaxDepthReached) === null || _b === void 0 ? void 0 : _b.call(_a))) {
    ...
    LazyLoadedSessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        var compressionEnabled = (_k = this._instance.config.session_recording.compress_events) !== null && _k !== void 0 ? _k : true;
        ...
        var _l = compressionEnabled
            ? compressEventSync(event)
            : { event: event, size: (0, sessionrecording_utils_1.estimateSize)(event) }, eventToSend = _l.event, size = _l.size;
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "sdkDebugProperties", {
        get: function () {
            ...
            return _a = {
                    ...
                    $sdk_debug_replay_flushed_size: (_b = this._flushedSizeTracker) === null || _b === void 0 ? void 0 : _b.currentTrackedSize(this.sessionId),
