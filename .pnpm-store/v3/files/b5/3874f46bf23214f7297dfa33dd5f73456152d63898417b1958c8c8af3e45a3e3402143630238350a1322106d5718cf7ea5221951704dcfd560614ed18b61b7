...
var RemoteConfigLoader = /** @class */ (function () {
    ...
    RemoteConfigLoader.prototype.refresh = function () {
        if (this._instance._shouldDisableFlags() || !globals_1.document || globals_1.document.visibilityState === 'hidden') {
            return;
        }
    ...
    RemoteConfigLoader.prototype._onRemoteConfig = function (config) {
        ...
        this._instance._onRemoteConfig(config ? { ok: true, config: config } : { ok: false });
