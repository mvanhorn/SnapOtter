...
declare function chineseSearchOptimize(input: string): string;

declare function formatShowDate(date: Date | string, lang: string): string;

declare function meta2string(frontmatter: Record<string, any>): string;
declare function pagefindPlugin(searchConfig?: SearchConfig & PagefindOption): any;

export { PagefindConfig, PagefindOption, PagefindResult, SearchConfig, SearchItem, chineseSearchOptimize, formatShowDate, meta2string, pagefindPlugin };
