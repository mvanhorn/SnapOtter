import { a as shouldSkipCodeInjection, i as isJsFile, r as createCodeTransformer, t as COMMENT_USE_STRICT_REGEX } from "./core-IEahUYJE.mjs";
...
function codeTransformerRollup(options) {
	const { transform: transformCode, getCodeToInject } = createCodeTransformer(options);
...
//#endregion
export { codeTransformerRollup as t };

//# sourceMappingURL=rollup-CnHq6lvH.mjs.map