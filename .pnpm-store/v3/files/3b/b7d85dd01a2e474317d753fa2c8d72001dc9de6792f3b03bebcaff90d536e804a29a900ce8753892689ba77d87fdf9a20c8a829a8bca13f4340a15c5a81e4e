...
export declare function cropToCanvas(image: HTMLImageElement, canvas: HTMLCanvasElement, crop: PixelCrop, scale?: number, rotate?: number): Promise<void>;

export declare function cropToImg(image: HTMLImageElement, crop: PixelCrop, scale?: number, rotate?: number): Promise<string>;
