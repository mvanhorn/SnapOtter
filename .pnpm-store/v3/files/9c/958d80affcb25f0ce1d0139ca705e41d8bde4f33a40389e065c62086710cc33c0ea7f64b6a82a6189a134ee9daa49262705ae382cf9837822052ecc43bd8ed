...
import { CaptureLogOptions, CaptureOptions, CaptureResult, Compression, ConfigDefaults, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, EventName, ExceptionAutoCaptureConfig, FeatureFlagsCallback, FeatureFlagOptions, FeatureFlagResult, JsonType, PostHogConfig, Properties, Property, QueuedRequestWithOptions, RemoteConfig, RemoteConfigResult, RequestCallback, SessionIdChangedCallback, SnippetArrayItem, ToolbarParams, PostHogInterface } from './types';
