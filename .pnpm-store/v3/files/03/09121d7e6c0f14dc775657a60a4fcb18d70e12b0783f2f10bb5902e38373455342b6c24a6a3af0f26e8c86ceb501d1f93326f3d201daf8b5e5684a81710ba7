...
async function b(e = {}) {
	...
	var pt = (e) => {
		...
		var [r, ...i] = Lt(e, t), a = r.toWireType.bind(r), o = i.map((e) => e.readValueFromPointer.bind(e));
		e--;
		var s = Array(e);
		return Ft(tt(`methodCaller<(${i.map((e) => e.name)}) => ${r.name}>`, (t, r, i, c) => {
...
var de = "d8bbaa9aa241d17c8f975b4b9b045d3db00fe05b9d3de84e6732dfff3005ef21";
//#endregion
